...
struct mgos_config_dwpc {
  ...
  int function_mode;
  int sensor_freq;
  int Inzonecount_threshold;
  int outzonecount_threshold;
};
...
/* dwpc.distance */
#define MGOS_CONFIG_HAVE_DWPC_DISTANCE
#define MGOS_SYS_CONFIG_HAVE_DWPC_DISTANCE
int mgos_config_get_dwpc_distance(const struct mgos_config *cfg);
int mgos_config_get_default_dwpc_distance(void);
static inline int mgos_sys_config_get_dwpc_distance(void) { return mgos_config_get_dwpc_distance(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_dwpc_distance(void) { return mgos_config_get_default_dwpc_distance(); }
void mgos_config_set_dwpc_distance(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_dwpc_distance(int v) { mgos_config_set_dwpc_distance(&mgos_sys_config, v); }
...
#define MGOS_CONFIG_HAVE_DWPC_BUZZER_FREQUENCY
#define MGOS_SYS_CONFIG_HAVE_DWPC_BUZZER_FREQUENCY
int mgos_config_get_dwpc_buzzer_frequency(const struct mgos_config *cfg);
int mgos_config_get_default_dwpc_buzzer_frequency(void);
static inline int mgos_sys_config_get_dwpc_buzzer_frequency(void) { return mgos_config_get_dwpc_buzzer_frequency(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_dwpc_buzzer_frequency(void) { return mgos_config_get_default_dwpc_buzzer_frequency(); }
void mgos_config_set_dwpc_buzzer_frequency(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_dwpc_buzzer_frequency(int v) { mgos_config_set_dwpc_buzzer_frequency(&mgos_sys_config, v); }

/* dwpc.buzzer_delay */
#define MGOS_CONFIG_HAVE_DWPC_BUZZER_DELAY
#define MGOS_SYS_CONFIG_HAVE_DWPC_BUZZER_DELAY
int mgos_config_get_dwpc_buzzer_delay(const struct mgos_config *cfg);
int mgos_config_get_default_dwpc_buzzer_delay(void);
static inline int mgos_sys_config_get_dwpc_buzzer_delay(void) { return mgos_config_get_dwpc_buzzer_delay(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_dwpc_buzzer_delay(void) { return mgos_config_get_default_dwpc_buzzer_delay(); }
void mgos_config_set_dwpc_buzzer_delay(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_dwpc_buzzer_delay(int v) { mgos_config_set_dwpc_buzzer_delay(&mgos_sys_config, v); }

/* dwpc.buzzer_off_time */
#define MGOS_CONFIG_HAVE_DWPC_BUZZER_OFF_TIME
#define MGOS_SYS_CONFIG_HAVE_DWPC_BUZZER_OFF_TIME
int mgos_config_get_dwpc_buzzer_off_time(const struct mgos_config *cfg);
int mgos_config_get_default_dwpc_buzzer_off_time(void);
static inline int mgos_sys_config_get_dwpc_buzzer_off_time(void) { return mgos_config_get_dwpc_buzzer_off_time(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_dwpc_buzzer_off_time(void) { return mgos_config_get_default_dwpc_buzzer_off_time(); }
void mgos_config_set_dwpc_buzzer_off_time(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_dwpc_buzzer_off_time(int v) { mgos_config_set_dwpc_buzzer_off_time(&mgos_sys_config, v); }
...
#define MGOS_CONFIG_HAVE_DWPC_INZONECOUNT_THRESHOLD
#define MGOS_SYS_CONFIG_HAVE_DWPC_INZONECOUNT_THRESHOLD
int mgos_config_get_dwpc_Inzonecount_threshold(const struct mgos_config *cfg);
int mgos_config_get_default_dwpc_Inzonecount_threshold(void);
static inline int mgos_sys_config_get_dwpc_Inzonecount_threshold(void) { return mgos_config_get_dwpc_Inzonecount_threshold(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_dwpc_Inzonecount_threshold(void) { return mgos_config_get_default_dwpc_Inzonecount_threshold(); }
void mgos_config_set_dwpc_Inzonecount_threshold(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_dwpc_Inzonecount_threshold(int v) { mgos_config_set_dwpc_Inzonecount_threshold(&mgos_sys_config, v); }

/* dwpc.outzonecount_threshold */
#define MGOS_CONFIG_HAVE_DWPC_OUTZONECOUNT_THRESHOLD
#define MGOS_SYS_CONFIG_HAVE_DWPC_OUTZONECOUNT_THRESHOLD
int mgos_config_get_dwpc_outzonecount_threshold(const struct mgos_config *cfg);
int mgos_config_get_default_dwpc_outzonecount_threshold(void);
static inline int mgos_sys_config_get_dwpc_outzonecount_threshold(void) { return mgos_config_get_dwpc_outzonecount_threshold(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_dwpc_outzonecount_threshold(void) { return mgos_config_get_default_dwpc_outzonecount_threshold(); }
void mgos_config_set_dwpc_outzonecount_threshold(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_dwpc_outzonecount_threshold(int v) { mgos_config_set_dwpc_outzonecount_threshold(&mgos_sys_config, v); }
